        ...
        {!isStudent && exams.length > 0 && (
          <div className="w-full md:w-auto">
            <select
              ...
              className="w-full md:w-64 px-3.5 py-2 bg-slate-50 border border-slate-200 rounded-xl text-sm font-semibold text-slate-800 focus:outline-none focus:ring-2 focus:ring-indigo-500/20"
            >
              {exams.map((ex) => (
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="bg-slate-50 border-b border-slate-200 text-xs font-bold text-slate-500 uppercase tracking-wider">
                  ...
                  <th className="py-4 px-6">Correct / Wrong</th>
                ...
                {filteredResults.map((item) => {
                  ...
                  return (
                    <tr key={item._id} className="hover:bg-slate-50/70 transition-colors">
                      ...
                      <td className="py-4 px-6">
                        {isStudent ? (
                          <span className="inline-block px-2.5 py-1 bg-indigo-50 text-indigo-700 rounded-lg text-xs font-bold">
